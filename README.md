...
- `send-zellij-message` automatically adds a delayed confirm Enter for long or multiline Codex payloads because one immediate Enter can leave the text staged instead of submitted.
