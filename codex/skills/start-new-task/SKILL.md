...
- Ask one focused question at a time with `request_user_input`.
...
- Present the plan review using `request_user_input` instead of a plain-text “should I continue?” follow-up.
