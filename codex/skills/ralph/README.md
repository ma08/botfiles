...
```bash
cp ~/.codex/skills/ralph/templates/AGENT.md .
cp ~/.codex/skills/ralph/templates/PROMPT.md .
cp ~/.codex/skills/ralph/templates/fix_plan.md .
cp ~/.codex/skills/ralph/templates/spec-template.md specs/
```
