...
2. **Copy templates** from `~/.claude/skills/ralph/templates/`
...
Use templates from `~/.claude/skills/ralph/templates/` as starting point.
...
**Dual-engine template** is at `~/.claude/skills/ralph/templates/run-ralph.sh`.
